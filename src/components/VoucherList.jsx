...
import { HiDesktopComputer, HiOutlinePencil, HiOutlineSearch, HiTrash } from "react-icons/hi";
      ...
      <div className="relative overflow-x-auto sm:rounded-lg">
          ...
          <div className='flex justify-between items-center my-3'>
              ...
              <div className=" inset-y-0 flex items-center ps-3.5 bg-blue-600 text-white rounded-md gap-3">
                ...
                <input type="text" className="w-full p-3 ps-10 text-sm text-gray-900 border focus:outline-none rounded-md" placeholder="Search Vouchers..." required />

              </div>

              <div className=''>
                  <Link to={"/sale"} className='bg-blue-700 text-white rounded-md p-2.5 focus:outline-none hover:bg-blue-600'>Create Sale  <HiDesktopComputer className='inline-block size-6'/> </Link>
              </div>
